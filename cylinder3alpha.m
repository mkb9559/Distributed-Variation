 function [Cylinder EndPlate1 EndPlate2] = cylinder3alpha(X1,X2,r,s,cyl_color,closed,lines,alpha)
%
...
if closed==1
    hold on
    EndPlate1=fill3(xx1(:,1),xx2(:,1),xx3(:,1),'r','FaceAlpha',alpha);
    EndPlate2=fill3(xx1(:,2),xx2(:,2),xx3(:,2),'r','FaceAlpha',alpha);
end

% Plotting the cylinder along the X-Direction with required length starting
% from Origin
Cylinder=mesh(xx1,xx2,xx3,'FaceAlpha',alpha);
% Cylinder=surf(xx1,xx2,xx3,'FaceAlpha',alpha);
